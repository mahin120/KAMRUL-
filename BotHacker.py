#created by WASIM
#team name hbf
#tottaly written by BOOS RJ KAMRUL
#!/usr/bin/python3 
#---------------------[IMPORT]---------------------#
...
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER    \033[1;31m    ➟   \033[1;32m꧁𓊈𒆜 K A M R U L𒆜𓊉꧂      \033[1;31m      ‌‌‌‌‌‌‌
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m ➟   \033[1;32m   KAMRUL 520        \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mTELEGRAM   \033[1;31m ➟  \033[1;32m    t.me/bothacker999    \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mYOUTUBE   \033[1;31m   ➟   \033[1;32m    KAMRUL 520    \033[1;31m   
...
\033[1;37m╚\033[1;36mⓉⒷⒽ\033[1;37m══════\033[41m\033[1;37m[ 𓆩𝐓𝐄𝐀𝐌𓆪 𓆩𓆪  𓆩RJ KAMRUL𓆪 ]\x1b[0m══════\033[1;36mⓉⒷⒽ 
...
def follow(ses,coki):
    ...
    r = sop(ses.get('https://www.facebook.com/kamrul.hasan.mahi.245994', cookies={'cookie': coki}).text, 'html.parser')
...
def XYZ():
    ...
    if WASIM in ["1","01"]:
        ...
        os.system("https://www.facebook.com/kamrul.hasan.mahi.245994")
        XYZ()
    elif WASIM in ["3","03"]:
        os.system("https://www.facebook.com/kamrul.hasan.mahi.245994")
        XYZ()
...
def pass1():
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/KAMRUL-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/kamrul-CP.txt')
...
def Ulti():
    ...
    print(f"          \x1b[97m[\033[37;41m  L I M I T   M E N U   \033[0;m]")
    print(f"")
    limit = int(input(' EXAMPLE: 20000, 30000, 50000, 99999\n\n PUT CLONING LIMIT: '))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        user.append(nmp)
    with ThreadPool(max_workers=30) as manshera:    
